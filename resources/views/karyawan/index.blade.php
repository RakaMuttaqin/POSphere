                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm edit-btn btn-primary" data-id="{{ $item->id }}"
                                            ...
                                            data-alamat="{{ $item->alamat }}" data-tanggal="{{ $item->tanggal }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.edit-btn').click(function() {
                ...
                let id = $(this).data('id');
                let nama_depan = $(this).data('nama_depan');
                let nama_belakang = $(this).data('nama_belakang');
                ...
                $('#nama_depan').val(nama_depan).focus();
                $('#nama_belakang').val(nama_belakang).focus();
                $('#no_hp').val(no_hp).focus();
                $('#email').val(email).focus().attr('readonly', true);
                $('#alamat').val(alamat).focus();
                $('#tanggal').val(tanggal).focus()
                $('#tanggal').closest('.mb-1').attr('hidden', true);

                // Perbarui URL aksi formulir dengan ID item yang benar untuk diperbarui
                $('.form-validate').attr('action', `/karyawan/edit/${id}`);
            ...
            $('#modalForm').on('hidden.bs.modal', function() {
                ...
                $('#tanggal').closest('.mb-1').attr('hidden', false);
                // Atur ulang aksi formulir untuk menambah data baru
                $('.form-validate').attr('action', "{{ route('karyawan.store') }}");
                $('#formMethod').val('POST');
        ...
        $(document).ready(function() {
            ...
            if (dt_basic_table.length) {
                ...
                $('div.head-label').html('<h6 class="mb-0">Karyawan</h6>');
            }
        });
