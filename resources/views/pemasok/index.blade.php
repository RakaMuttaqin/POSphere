    ...
    <script>
        ...
        $(document).ready(function() {
            $('.edit-btn').click(function() {
                ...
                $('.form-validate').attr('action', `/pemasok/edit/${id}`);
                $('#formMethod').val('PUT');

                // Change the modal title to "Edit Pemasok"
                $('#modalFormTitle').text('Edit Pemasok');
            });
            ...
            $('#modalForm').on('hidden.bs.modal', function() {
                ...
                $('.form-validate').attr('action', "{{ route('pemasok.store') }}");
                $('#formMethod').val('POST');
        ...
        $(document).ready(function() {
            ...
            if (dt_basic_table.length) {
                ...
                $('div.head-label').html('<h6 class="mb-0">Pemasok</h6>');
            }
        });
        ...
        $(document).ready(function() {
            $('.form-validate').validate({
                ...
                messages: {
                    ...
                    no_hp: {
                        required: "Nomor Telepon Pemasok harus diisi.",
                        minlength: "Nomor Telepon Pemasok minimal 11 karakter.",
                        maxlength: "Nomor Telepon Pemasok maksimal 13 karakter."
                    },
                    email: {
                        required: "Email Pemasok harus diisi.",
