    ...
    <script>
        ...
        $(document).ready(function() {
            $('.edit-btn').click(function() {
                ...
                $('.form-validate').attr('action', `/satuan/edit/${id}`);
                $('#formMethod').val('PUT');

                // Change the modal title to "Edit Satuan"
                $('#modalFormTitle').text('Edit Satuan');
            });
            ...
            $('#modalForm').on('hidden.bs.modal', function() {
                ...
                $('.form-validate').attr('action', "{{ route('satuan.store') }}");
                $('#formMethod').val('POST');
        ...
        $(document).ready(function() {
            ...
            if (dt_basic_table.length) {
                ...
                $('div.head-label').html('<h6 class="mb-0">Satuan</h6>');
            }
        });
