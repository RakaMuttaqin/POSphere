                        ...
                        <tbody>
                            @foreach ($pembelian as $item)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-detail btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#modalDetail" data-id="{{ $item->kode }}">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#searchBarang').on('select2:select', function(e) {
                ...
                // Reset input pencarian dengan delay kecil agar lebih smooth
                setTimeout(() => {
        ...
        function tambahKeTabel(kode, nama, harga_beli, harga_jual) {
            let tableBody = document.querySelector("#detailPembelian tbody");
            let rowCount = tableBody.rows.length; // Hitung jumlah baris untuk menentukan indeks

            let newRow = `
                <tr>
                    <td><input type="hidden" name="details[${rowCount}][kode_barang]" value="${kode}">${nama}</td>
                    <td><input type="number" class="form-control" name="details[${rowCount}][jumlah]" required></td>
                    <td><input type="number" class="form-control numeral-mask" name="details[${rowCount}][harga_beli]" value="${harga_beli}" required></td>
                    <td><input type="number" class="form-control numeral-mask" name="details[${rowCount}][harga_jual]" value="${harga_jual}" required></td>
                    <td><input type="datetime-local" class="form-control" name="details[${rowCount}][tanggal_expired]" required></td>
        ...
        // Hapus baris ketika tombol remove diklik
